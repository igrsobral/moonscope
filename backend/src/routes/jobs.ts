  ...
  fastify.get(
    ...
    async (request, reply) => {
      try {
        ...
        request.log.error(
          { error: error instanceof Error ? error.message : String(error) },
          'Failed to get job health status'
        );
        return reply.code(500).send({
          success: false,
          error: {
    ...
    async (request, reply) => {
      try {
        const {
          ...
          data = {},
          delay,
        } = request.body as z.infer<typeof TriggerJobSchema>;
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        ...
        request.log.error(
          { error: error instanceof Error ? error.message : String(error) },
          'Failed to schedule price update'
        );
        return reply.code(500).send({
          success: false,
          error: {
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        ...
        request.log.error(
          { error: error instanceof Error ? error.message : String(error) },
          'Failed to schedule social scraping'
        );
        return reply.code(500).send({
          success: false,
          error: {
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        ...
        request.log.error(
          { error: error instanceof Error ? error.message : String(error) },
          'Failed to schedule risk assessment'
        );
        return reply.code(500).send({
          success: false,
          error: {
