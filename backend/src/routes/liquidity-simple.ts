...
export default async function liquidityRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/coins/:coinId/pools', {
  ...
  fastify.get('/coins/:coinId/analysis', {
    preHandler: fastify.authenticate,
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const validatedParams = CoinIdParamsSchema.parse(request.params);
  ...
  fastify.get('/coins/:coinId/trends', {
    preHandler: fastify.authenticate,
  }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const validatedParams = CoinIdParamsSchema.parse(request.params);
      ...
      const result = await liquidityService.getLiquidityTrends(validatedParams.coinId, validatedQuery.timeframe);
  ...
  fastify.post('/sync', {
    ...
    try {
      ...
      const result = await liquidityService.syncLiquidityPools(validatedBody.coinId, validatedBody.tokenAddress);
  ...
  fastify.put('/alerts/:alertId', {
    ...
    try {
      ...
      const result = await liquidityService.updateLiquidityAlert(validatedParams.alertId, validatedBody);
